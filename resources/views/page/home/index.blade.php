                            ...
                            @foreach($locations as $location)
                                <div class="item">
                                    <div class="project-destination">
                                        <a href="#" class="img" style="background-image: url({{ asset('page/images/hotel.jpg') }});">
                                            <div class="text">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 text-center">
                    <div class="img"  style="background-image: url({{ asset('page/images/bg_2.jpg') }});">
                        ...
                        <p class="mb-0"><a href="https://m.me/datyeuems1" class="btn btn-primary px-4 py-3">Liên hệ qua Messager của chúng tôi</a></p>
                    </div>
                </div>
            </div>
        </div>
